    ...
    for (let index = 0; index < dataBlog.length; index++) {
      ...
      techImages += `<img src="assets/images/${dataBlog[index].technology[i]}.jpg">`;
        ...
        <div class="blog-content">
          ...
          <p class="duration">Start Date : ${dataBlog[index].startDate}</p>
          <p class="duration">End Date : ${dataBlog[index].endDate}</p>
          <p class="desc">${dataBlog[index].description}</p>
          <div class="tech-images">
          ${techImages}
          </div>
          <p class="published">Post At: ${getFullTime(dataBlog[index].postAt)}</p>
